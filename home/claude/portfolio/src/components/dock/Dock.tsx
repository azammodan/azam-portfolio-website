...
function DockItem({
  ...
  return (
    <div className="relative flex flex-col items-center" style={{ width: 42 }}>
      ...
      {hovered && (
        <div
          className="absolute bottom-full mb-2 whitespace-nowrap rounded-md border border-[var(--desktop-border)] bg-[var(--desktop-surface)] px-2 py-1 text-[11px] text-[var(--desktop-text)] pointer-events-none"
